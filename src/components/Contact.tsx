         ...
         <div className="container mx-auto px-4 md:px-6">
            ...
            >
               ...
               <p className="text-gray-300">
                  Have a project in mind or just want to say hello? Feel free to reach out to me. I'm always open to discussing new projects and
                  opportunities.
               </p>
            </div>
                     ...
                     <div className="space-y-6">
                        <div className="flex items-start space-x-4">
                           ...
                           <div>
                              ...
                              <p className="text-gray-300 text-sm">Curitiba, Parana, Brazil</p>
                           </div>
                        </div>
                           ...
                           <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                              ...
                              <div>
                                 ...
                                 <input
                                    ...
                                    className="w-full bg-dark-700 border border-dark-600 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent transition-all"
                                    placeholder="peterparker@spiders.com"
                                 />
                              </div>
                           </div>
